...
// EXTERNAL MODULE: ./node_modules/lodash/isArray.js
var isArray = __webpack_require__(1469);
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/core/dom/escapeHTML.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/core/dom/stripTags.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/lineTypes.js
/**
 * @enum {String}
 * @readonly
 */
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/matchers/isTimeSignatureString.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseTimeSignature.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/syntax.js
...
const syntax_defaultTimeSignature = parseTimeSignature_parseTimeSignature('4/4');

;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/matchers/isChord.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/matchers/isChordLine.js
...
const chordBeatCountSymbols = new RegExp(
	escapeRegExp_default()(parser_syntax.chordBeatCount) + '*$',
	'g'
);
const barRepeatSymbols = new RegExp(
	'^' + escapeRegExp_default()(parser_syntax.barRepeat) + '+$'
);
 ...
 * @returns {Boolean}
 */
function isChordLine_isChordLine(line = '') {
	return clearSpaces(isChordLine_getParseableChordLine(line))
		.split(' ')
		.every((potentialChordToken, index, allTokens) => {
			const clean = isChordLine_cleanToken(potentialChordToken);
...
const isChordLine_getParseableChordLine = (chordLine) => {
	return chordLine.replaceAll('add ', 'add');
};

const isChordLine_cleanToken = (token) => {
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/matchers/isChordLineRepeater.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/matchers/isSectionLabel.js




const isSectionLabel_sectionLabelRegexp = new RegExp(
	'^' + escapeRegExp_default()(parser_syntax.sectionLabel) + '([a-zA-Z]+)([1-9])?( x[2-9])?$'
);

function isSectionLabel_isSectionLabel(string) {
	const found = clearSpaces(string).match(isSectionLabel_sectionLabelRegexp);
	return found !== null;
}

// EXTERNAL MODULE: ./node_modules/lodash/isEqual.js
var isEqual = __webpack_require__(8446);
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseChord.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/exceptions/InvalidBeatCountException.js



class InvalidBeatCountException_InvalidBeatCountException extends Error {
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/exceptions/InvalidChordRepetitionException.js


class InvalidChordRepetitionException_InvalidChordRepetitionException extends Error {
	constructor({ string } = {}) {
		if (!string || !_isString(string)) {
			throw new TypeError(
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/exceptions/InvalidSubBeatGroupException.js



class InvalidSubBeatGroupException_InvalidSubBeatGroupException extends Error {
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/exceptions/InvalidBarRepeatException.js


class InvalidBarRepeatException_InvalidBarRepeatException extends Error {
	constructor({ string } = {}) {
		if (!string || !_isString(string)) {
			throw new TypeError(
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseChordLine.js
...
const parseChordLine_chordBeatCountSymbols = new RegExp(
	escapeRegExp_default()(parser_syntax.chordBeatCount),
	'g'
);
const parseChordLine_barRepeatSymbols = new RegExp(
	'^' + escapeRegExp_default()(parser_syntax.barRepeat) + '+$'
);
 ...
 * @returns {ChordLine}
 */
function parseChordLine_parseChordLine(
	chordLine,
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/matchers/isKeyDeclaration.js





const isKeyDeclaration_keyDeclarationRegexp = new RegExp(
	'^' + escapeRegExp_default()(parser_syntax.keyDeclarationPrefix) + '([ABCDEFG].*)$'
);

function isKeyDeclaration_isKeyDeclaration(string) {
	const found = clearSpaces(string).match(isKeyDeclaration_keyDeclarationRegexp);
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/helper/keyHelpers.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseKeyDeclaration.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseLyricLine.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseSectionLabel.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/helper/songs.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/songLinesFactory.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/getAllChordsInSong.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/getAllKeysInSong.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/parser/parseSong.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/symbols.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/spacers/chord/getBeatString.js
 ...
 * @returns {String}
 */
function getBeatString_getBeatString(bar, beat, shouldPrintSubBeatDelimiters = true) {
	...
	switch (beatChords.length) {
		case 0:
			return '';
		case 1: {
			return getBeatString_getChordString(
				bar,
				beatChords[0],
		...
		default: {
			return beatChords.reduce((allChords, chord, i) => {
				...
				return (
					allChords +
					spacesBefore +
					getBeatString_getChordString(bar, chord, shouldPrintSubBeatDelimiters)
				);
			}, '');
		}
	}
...
function getBeatString_getChordString(bar, chord, shouldPrintSubBeatDelimiters) {
	if (!chord.isInSubBeatGroup) {
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/spacers/chord/getMaxBeatsWidth.js
 ...
 * @returns {Array}
 */
function getMaxBeatsWidth_getMaxBeatsWidth(
	allLines,
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/spacers/chord/simple.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/spacers/chord/aligned.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/spacers/chord/chordLyrics.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/components/renderChordSymbol.js
 ...
 */
function renderChordSymbol_renderChordSymbol(
	chord,
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/components/renderBarContent.js
 ...
 * @returns {String} rendered html
 */
function renderBarContent_renderBarContent(
	bar,
	isLastBar = false,
	{
		shouldPrintBarSeparators = true,
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/components/renderChordLine.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/components/renderKeyDeclaration.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/helpers/getChordSymbol.js
 ...
 * @returns {string}
 */
/* harmony default export */ function helpers_getChordSymbol(model, renderChord = defaultRenderChord) {
	switch (model) {
		case syntax.noChord:
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/helpers/renderAllSectionLabels.js
...
function renderAllSectionLabels_renderAllSectionsLabels(
	allLines,
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/replaceRepeatedBars.js



const replaceRepeatedBars_replaceRepeatedBars = (line, { alignChordsWithLyrics }) => {
	if (line.type === lineTypes.CHORD) {
		line.model.allBars.forEach((bar) => {
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/renderer/components/renderSong.js
...
;// CONCATENATED MODULE: ./node_modules/chord-mark/src/chordMark.js
