...
Their sheer simplicity makes them a universally and immediately understood language.
...
After all, the foundations of the current format have been defined [almost 30 years ago](https://www.chordpro.org/chordpro/chordpro-history/) and haven't changed much since. 
