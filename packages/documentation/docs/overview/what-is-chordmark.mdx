...
- an Open Source Javascript module, `chord-mark`, that can be used to process <CM/> files and format them with a high degree of customization.
...
ChordMark has some unique features that makes it stand out from other chord charts formats:
