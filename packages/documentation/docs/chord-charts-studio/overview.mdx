...
Of course, the chord chart needs to be written following the <CM/> syntax (link to doc).
...
- **Expand copied sections**: xxx

### Layout

- **Columns**: xxx
- **Column break on section**: avoid splitting a section in two different columns
- **Margins**: 
