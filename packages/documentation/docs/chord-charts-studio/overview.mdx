...
Chord Charts Studio is the official editor of <CM />: it is [freely available online](http://chord-chart-studio.netlify.app).
...
- **Screen view**: this mode is useful if you wish to play the song by directly looking at your computer screen.
