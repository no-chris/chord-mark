...
Tech-savvy users can also access directly the local storage content and back it up, for example in [Chrome](https://developer.chrome.com/docs/devtools/storage/localstorage/).
