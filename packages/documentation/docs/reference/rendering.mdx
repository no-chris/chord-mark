...
This is very useful for band members that do not need the lyrics. For example: 
...
Thanks to `ChordMark` automatic alignment of bars between lines, one might actually find it clearer NOT to align the chords symbols with the lyrics.
