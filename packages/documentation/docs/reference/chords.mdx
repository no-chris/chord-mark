...
If some chords should be played for less than one beat, you can use the sub-beat delimiters to create a group of chords that should be played during the same beat.

<TabbedChordMark src={'C.. G..\nWhen I _find myself in _times of trouble\nAm. {Am Am/G} FM7. F6.\n_ Mother _Ma_ry _comes to _me'} />

Within the sub-beat delimiters, the chord duration is defined by the number of chords in the group:

<TabbedChordMark src={'8th notes:\nC.. G. {Am Am/G}\n8th notes triplet:\nC.. G. {Am Am/G F}\n16th notes:\nC.. G. {Am Am/G F C}'} />

A sub-beat group definition is invalid if it contains chord duration markers, a single chords, or more than 4 chords:
